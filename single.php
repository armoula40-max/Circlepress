	...
	<div class="<?php echo esc_attr( circlepress_layout_class() ); ?>" style="margin-top:18px">
		<div>
			...
			while ( have_posts() ) :
				...
				?>
					<article id="post-<?php the_ID(); ?>" <?php post_class( 'cp-single cp-single--reference' ); ?>>
						<?php if ( has_post_thumbnail() ) : ?>
							<figure class="cp-single__thumb cp-single__reference-image"><?php the_post_thumbnail( 'large' ); ?></figure>
						<?php endif; ?>
					...
					<h1 class="cp-single__title"><?php the_title(); ?></h1>
						...
						<?php elseif ( has_excerpt() ) : ?><p class="cp-single__subtitle"><?php echo esc_html( circlepress_clean_excerpt( null, 34 ) ); ?></p><?php endif; ?>
