...
function circlepress_get_niches() {
	return array(
		'food'       => array(
			...
			'hero_title'  => __( 'Delicious recipes, tested in a real kitchen', 'circlepress' ),
			'hero_sub'    => __( 'Weeknight dinners, cozy baking and 30-minute meals your family will ask for again.', 'circlepress' ),
		),
		'crochet'    => array(
